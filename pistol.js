...
class Pistol {
    ...
    Shoot(pos, vel) {
        soundManager.GetSound("shoot").Stop();
    ...
    Update(pos, dir, dt) {
        ...
        if(KeyDown(KeyCode.KEY_UP) ||
           ...
           KeyDown(KeyCode.KEY_RIGHT)) {
            ...
            if(this.timer >= 0.1) {
                //let mouseP = new Vec2(MouseX(), MouseY());
